...
export const metadata: Metadata = {
  ...
  title: {
    default: "DirectDrop — Files between two open browsers",
  ...
  openGraph: {
    ...
    url: "/",
    siteName: SITE_NAME,
    title: "DirectDrop — Files between two open browsers",
    description: SITE_DESCRIPTION,
...
const structuredData = [
  {
    ...
    featureList: [
      ...
      "Encrypted between the two browsers (WebRTC DTLS)",
      "No account and no app install",
      "Link and QR code connection",

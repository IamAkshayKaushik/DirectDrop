        ...
        <header className="text-left mb-8">
          <div className="flex items-start justify-between gap-3 mb-3">
            ...
            <button
              ...
              className="shrink-0 p-2 rounded-lg text-slate-500 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-slate-700 dark:hover:text-slate-200 transition-colors"
            >
              {isDark ? (
